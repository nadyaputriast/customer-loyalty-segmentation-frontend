...
export default function ActivityChartSection({
  ...
  return (
    <Card className="rounded-2xl border-zinc-200/80 shadow-sm bg-white w-full">
      <CardHeader className="flex flex-row items-center justify-between px-8">
        ...
        <div className="flex items-center gap-2">
          ...
          <Select value={timeRange} onValueChange={setTimeRange}>
            <SelectTrigger className="h-8 rounded-full text-xs font-medium border-zinc-200 text-zinc-600 hidden sm:flex w-[200px]">
          ...
          <Button
            variant="secondary"
            size="sm"
            className="rounded-full h-8 text-xs py-4.5 border-zinc-200 font-medium bg-zinc-100 hover:bg-zinc-200 text-zinc-600"
          >
            View report
          </Button>
        </div>
      ...
      <div className="px-8 flex gap-4 text-xs text-muted-foreground">
